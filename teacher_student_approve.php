...
<html lang="en">
<head>
    <title>Approve Student Returns</title>
	...
	<tr>
		...
		<td style="left-align">
			...
			<table style="width: 100%">
			     <caption style="text-align: center; "><h1><?php echo $_SESSION["user_name"]; ?> Approve Student Returns </h1></caption>
			     <tr>
				<td>
		...
		<BR>
		   ...
		   try{ 
                   $sql = "SELECT * FROM activity where teacher_appr = 1";
                            ...
                            echo '<table id = "table1" style="width: 100%;">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr style='text-align: center'>";
                                        ...
                                        echo "<td>";
                                        echo '<a href="teacher_student_approve_return.php?id='. $row['item_id'] . "-" . $row['user_id'] .'">Approve</a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
