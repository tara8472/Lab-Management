	...
	<tr>
		...
		<td style="left-align">
			...
			<table style="width: 100%">
			     <caption style="text-align: center; "><h1><?php echo $_SESSION["user_name"]; ?> Borrow Items </h1></caption>
			     <tr>
				<td>
                            ...
                            echo '<table id = "table1" style="width: 100%;">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr style='text-align: center'>";
                                        ...
                                        echo "<td>";
	                                echo '<a href="teacher_borrow_item.php?id='. $row['item_id'] .'">Borrow</a>';
        	                        echo "</td>";
/*


					if ($row['item_auth'] == 1){
	                                        echo "<td> Contact Teacher </td>";
					}
					else{
                                        	echo "<td>";
	                                        echo '<a href="student_borrow_item.php?id='. $row['item_id'] .'">Borrow</a>';
        	                                echo "</td>";
					}
*/
                                    echo "</tr>";
